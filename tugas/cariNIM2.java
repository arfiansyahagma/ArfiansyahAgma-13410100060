   ...
   if (piluser == 1)
    {
      ...
      for(int k =0;k<daftarMahasiswa.length;k++){
        if(daftarMahasiswa[k][0].equals(nim)){
      System.out.println();
          System.out.println(daftarMahasiswa[k][0]+"  "+ daftarMahasiswa[k][1] );
          System.out.println();
  ...
  if (piluser == 2)
    {
      ...
      for(int k =0;k<daftarMahasiswa.length;k++){
        if(daftarMahasiswa[k][1].equals(nama)){
      System.out.println();
          System.out.println(daftarMahasiswa[k][0]+"  "+ daftarMahasiswa[k][1] );
          System.out.println();
          System.out.println("Pada data ke "+k);
   ...
   if (piluser == 3)
    {
      ...
      for(int k =0;k<daftarMahasiswa.length;k++){
        if(daftarMahasiswa[k][0].contains(nim)){
  System.out.println();
          System.out.println(daftarMahasiswa[k][0]+"  "+daftarMahasiswa[k][1]);
    System.out.println();
          System.out.println("Pada data ke "+k);
...
if (piluser == 4)
    {
      ...
      for(int k =0;k<daftarMahasiswa.length;k++){
        if(daftarMahasiswa[k][1].contains(nama)){
  System.out.println();
          System.out.println(daftarMahasiswa[k][0]+"  "+daftarMahasiswa[k][1]);
    System.out.println();
          System.out.println("Pada data ke "+k);
